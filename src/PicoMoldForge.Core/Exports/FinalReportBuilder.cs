...
public sealed class FinalReportBuilder
{
        ...
        DateTimeOffset generatedAtUtc)
    {
        ...
        var warnings = new List<string>
        {
            ...
            "Generated STL artifacts are diagnostic, preliminary, or functional-preliminary unless explicitly validated by a qualified engineer."
        };
    ...
    public ExportManifest CreateStandardManifest(string outputDirectory)
    {
        ...
        var artifacts = new[]
        {
            ...
            CreateArtifact(ExportArtifactKind.Cavity, outputDirectory, "Cavity.stl", "Legacy preliminary cavity diagnostic STL.", isRequired: true),
            ...
            CreateArtifact(ExportArtifactKind.Core, outputDirectory, "Core.stl", "Legacy preliminary core diagnostic STL.", isRequired: true),
            CreateArtifact(ExportArtifactKind.BooleanCoreSide, outputDirectory, "BooleanCoreSide.stl", "Functional-preliminary core-side mold half generated by split voxel subtraction.", isRequired: true),
            CreateArtifact(ExportArtifactKind.BooleanCavitySide, outputDirectory, "BooleanCavitySide.stl", "Functional-preliminary cavity-side mold half generated by split voxel subtraction.", isRequired: true),
        ...
        var warnings = new[]
        {
            "Standard manifest contains expected artifact paths only; file existence is verified by export orchestration.",
            "Boolean cavity/core side artifacts are functional-preliminary and still require engineering validation.",
